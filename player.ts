...
import { PLAYER_BASE_HP, PLAYER_BASE_MANA, PLAYER_BASE_SPEED, PLAYER_ATTACK_RATE, expNeeded, CAP_BASE, CAP_PER_LEVEL } from "../config.ts";
import { SPR } from "../gfx/sprites.ts";
import { moveSpeedBonus } from "../systems/skills.ts";
import { activeBonus } from "../systems/derived.ts";
import { emptyBag, emptyEquipment, gearStat, itemWeight, bagWeight } from "../items.ts";
