...
export const BAKED_ITEM_SPR: Readonly<Record<ItemKind, HTMLCanvasElement>> = {
  ...
  // …and so do the effigy and the earring. All four relics ship with their
  // own artwork and none of them has ever shown this bake on a real screen;
  // it is here because the table must be total over `ItemKind`, and because a
  ...
  zephyrHelm: SPR.gearStubHead, zephyrBody: SPR.gearStubBody, zephyrLegs: SPR.gearStubLegs, zephyrBoots: SPR.gearStubBoots,
  goldenShield: SPR.gearStubShield, vampireShield: SPR.gearStubShield, sunspear: SPR.gearStubWeapon, bloodletter: SPR.gearStubWeapon,
