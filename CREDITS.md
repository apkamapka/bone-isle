...
Five files, generated by `tools/fx/gen_rune_art.py`, each 256 x 32 — eight
frames in one horizontal strip.
...
**Five colourways, and Mending is not green.** Protective keeps the leaf green
